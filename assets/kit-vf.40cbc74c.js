import"./dynamic-import-polyfill.feac7147.js";import{V as e,b as p}from"./vendor.ce0c5a8e.js";/* empty css                            */import{n as l,t as m,l as c}from"./vueComponentNormalizer.3eea0038.js";var k=`.theme--light.v-application {
  background: #FFFFFF;
...
/*# sourceMappingURL=vuetify.css.map*/`,v=function(){var n=this,a=n.$createElement,t=n._self._c||a;return t("v-app",[t("v-tabs",{attrs:{centered:""},model:{value:n.tab,callback:function(i){n.tab=i},expression:"tab"}},[t("v-tabs-slider"),n._v(" "),t("v-tab",{attrs:{href:"#swap"}},[n._v("Donate")]),n._v(" "),t("v-tab",{attrs:{href:"#pool"}},[n._v("Proposals")]),n._v(" "),t("v-tab",{attrs:{href:"#vote"}},[n._v("Missions")]),n._v(" "),t("v-tabs-items",{model:{value:n.tab,callback:function(i){n.tab=i},expression:"tab"}},[t("v-tab-item",{attrs:{value:"swap"}},[t("v-card",{staticClass:"my-4 mx-4 px-4 py-4",attrs:{elevation:"2"}},[t("v-row",[t("v-col",{attrs:{md:"4"}},[t("v-text-field",{attrs:{label:"Amount"},model:{value:n.swap.amount,callback:function(i){n.$set(n.swap,"amount",i)},expression:"swap.amount"}})],1),n._v(" "),t("v-col",{attrs:{md:"4"}},[t("v-autocomplete",{attrs:{label:"Pick a currency",items:n.swap.tokens},model:{value:n.swap.token,callback:function(i){n.$set(n.swap,"token",i)},expression:"swap.token"}})],1)],1),n._v(" "),t("v-text-field",{attrs:{label:"ENS or Wallet",error:!0,"error-messages":"This address seems unreachable"}}),n._v(" "),t("v-btn",{staticClass:"mt-4",attrs:{color:"primary"}},[n._v("Search variants")])],1)],1),n._v(" "),t("v-tab-item",{attrs:{value:"pool"}},[t("v-card",[t("v-radio-group",{attrs:{name:"category",row:""},scopedSlots:n._u([{key:"label",fn:function(){return[n._v(`
              Category
            `)]},proxy:!0}])},[n._v(" "),t("v-radio",{attrs:{label:"Proposal",value:"proposal"}}),n._v(" "),t("v-radio",{attrs:{label:"Suggestion",value:"suggestion"}}),n._v(" "),t("v-radio",{attrs:{label:"Idea",value:"idea"}})],1),n._v(" "),t("v-textarea",{attrs:{label:"Message",error:n.pool.message.length<10,"error-messages":n.pool.message.length<10?"Enter at least 10 characters":null,rows:"5"},model:{value:n.pool.message,callback:function(i){n.$set(n.pool,"message",i)},expression:"pool.message"}}),n._v(" "),t("v-btn",{attrs:{color:"success",outlined:"",block:""},on:{click:function(i){n.pool.modal=!0}}},[n._v(`Send idea
          `)])],1)],1),n._v(" "),t("v-tab-item",{attrs:{value:"vote"}},[t("v-expansion-panels",n._l(n.vote.cases,function(i,r){return t("v-expansion-panel",{key:r},[t("v-expansion-panel-header",[t("div",{staticClass:"d-flex justify-space-between"},[t("span",[n._v(n._s(i.mission_name))]),n._v(" "),t("v-chip",{attrs:{small:"",color:"teal","text-color":"white"}},[n._v(n._s(i.rocket.rocket_name))])],1)]),n._v(" "),t("v-expansion-panel-content",[n._v(`
              `+n._s(i.details)+`
            `)])],1)}),1)],1)],1)],1),n._v(" "),t("v-dialog",{model:{value:n.pool.modal,callback:function(i){n.$set(n.pool,"modal",i)},expression:"pool.modal"}},[t("v-card",[t("v-card-title",[n._v("Idea box")]),n._v(" "),t("v-card-text",[t("v-textarea",{attrs:{label:"Message",error:n.pool.message.length<10,"error-messages":n.pool.message.length<10?"Enter at least 10 characters":null,rows:"5"},model:{value:n.pool.message,callback:function(i){n.$set(n.pool,"message",i)},expression:"pool.message"}})],1),n._v(" "),t("v-card-actions",[t("v-spacer"),n._v(" "),t("v-btn",{attrs:{color:"secondary"},on:{click:function(i){n.pool.modal=!1}}},[n._v("Close")]),n._v(" "),t("v-btn",{attrs:{color:"success"},on:{click:function(i){n.pool.modal=!1}}},[n._v("Apply")])],1)],1)],1)],1)},d=[],y=`
...
`;const s={data(){return{tab:"",swap:{token:"",amount:.15,tokens:m.map(n=>({value:n.symbol,text:n.name}))},pool:{message:"SpaceX is developing a low latency, broadband internet system to meet the needs of consumers across the globe. Enabled by a constellation of low Earth orbit satellites, Starlink will provide fast, reliable internet to populations with little or no connectivity, including those in rural communities and places where existing services are too expensive or unreliable.",modal:!1},vote:{cases:c,active:0}}}},o={};var g=l(s,v,d,!1,x,"cb32c7dc",null,null);function x(n){for(let a in o)this[a]=o[a]}var f=g.exports;e.use(p);const b=new p({icons:{iconfont:"mdi"}});new e({vuetify:b,render:n=>n(f)}).$mount("#app");
